...
public class RefreshTokens extends TableImpl<RefreshTokensRecord> {
    ...
    /**
     * The column <code>public.refresh_tokens.refresh_token_id</code>.
     */
    public final TableField<RefreshTokensRecord, Long> REFRESH_TOKEN_ID = createField(DSL.name("refresh_token_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<RefreshTokensRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
